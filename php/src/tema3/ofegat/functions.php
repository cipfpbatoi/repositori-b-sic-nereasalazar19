...
function generarPalabraAleatoriamente(){
    $arrayPalabras = ['vidrio', 'perlas', 'abrochar', 'comillas', 'coctelera', 'quince', 'arpa', 'baraja', 'amistoso', 'asalto'];
    $palabraSeleccionada = $arrayPalabras[array_rand($arrayPalabras)];
